...
export async function authRoutes(fastify: FastifyInstance) {
  // Guard against missing database pool - return 503 instead of throwing
  if (!pool) {
    // Register placeholder routes that return service unavailable
    const unavailableHandler = async (request: any, reply: any) => {
