    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://motion-mavericks-pty-ltd.sentry.io/issues/?project=4509948666183680">Issues Page</a>.
