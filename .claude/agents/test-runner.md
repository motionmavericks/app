...
## MCP-Integrated UI Checks (Development)
- When the main agent indicates browser-visible changes, coordinate with `external-delegator` to run a minimal Playwright MCP flow (navigate, action, assert) and include the result summary in your output. Keep it fast and focused.
